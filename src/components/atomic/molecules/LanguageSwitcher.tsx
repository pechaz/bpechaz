...
export function LanguageSwitcher() {
  ...
  return (
    <button
      ...
      className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg px-2 text-[var(--foreground-muted)] transition-colors hover:bg-[var(--hover-bg)] hover:text-[var(--foreground)]"
